        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="w-auto">
                <ul className="menu menu-horizontal gap-10">
                    <li>
                        <a href="#" target="_blank" className="tooltip aspect-square w-10 p-0" data-tip="Facebook">
                    ...
                    <li>
                        <a href="#" target="_blank" className="tooltip aspect-square w-10 p-0" data-tip="X">
                    ...
                    <li>
                        <a href="#" target="_blank" className="tooltip aspect-square w-10 p-0" data-tip="Instagram">
